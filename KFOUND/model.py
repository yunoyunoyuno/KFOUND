...
class KFoundModel(nn.Module):
    def __init__(
        ...
        super(KFoundModel, self).__init__()
    ...
    def forward_step(self, batch, decoder=None, for_eval=False):
        ...
        with torch.no_grad():
            ...
            feats = feats[:, 1:, :, :].reshape(att.shape[0], w_featmap, h_featmap, -1); #[B,w_feat,H_feat,384]
            feats = feats.permute(0, 3, 1, 2); #[B,384,w_feat,H_feat]
